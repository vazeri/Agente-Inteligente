...
nPr = (math.factorial(n))/(math.factorial(n-n)) #Formula de permutacion
#Importa la posicion de los elementos en el grupo 
nCr = math.factorial(nPr) #Formula de combinaciones
#Importa la prescencia de los elementos en el grupo formado
...
raw_input("Desea ver los caminos? (enter) \n") 
